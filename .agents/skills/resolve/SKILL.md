...
```bash
python3 /Users/0xvox/Documents/GitHub/FinceptTerminal/.Codex/skills/resolve/resolve.py \
  <target> [--bets=N] [--save]
```
...
script writes to
`/Users/0xvox/.Codex/projects/-Users-0xvox-Documents-GitHub-FinceptTerminal/memory/<handle>-reverse-engineering.md`
...
`/Users/0xvox/Documents/GitHub/FinceptTerminal/.Codex/skills/resolve/adapters/`:
