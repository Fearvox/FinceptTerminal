---
name: everything-Codex-conventions
description: Development conventions and patterns for everything-Codex. JavaScript project with conventional commits.
---

# Everything Codex Conventions

> Generated from [affaan-m/everything-Codex](https://github.com/affaan-m/everything-Codex) on 2026-03-20

## Overview

This skill teaches Codex the development patterns and conventions used in everything-Codex.
...
```text
feat: add block-no-verify hook for Codex and Cursor (#649)
```
