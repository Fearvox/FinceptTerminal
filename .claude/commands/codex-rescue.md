...
```bash
node "/home/user/claude-code-reimagine-for-learning/.claude/codex-plugin/codex-companion.mjs" task-resume-candidate --json
```
...
- The subagent is a thin forwarder only. It should use one `Bash` call to invoke `node "/home/user/claude-code-reimagine-for-learning/.claude/codex-plugin/codex-companion.mjs" task ...` and return that command's stdout as-is.
