...
- Run:
```bash
node "/home/user/claude-code-reimagine-for-learning/.claude/codex-plugin/codex-companion.mjs" review "$ARGUMENTS"
```
...
```typescript
Bash({
  command: `node "/home/user/claude-code-reimagine-for-learning/.claude/codex-plugin/codex-companion.mjs" review "$ARGUMENTS"`,
